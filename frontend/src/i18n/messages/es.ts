...
export const es: EnglishMessages = {
  ...
  landing: {
    ...
    features: {
      ...
      body: 'Hazina — tesoro en suajili — representa el valor desaprovechado de tu inteligencia on-chain. Deja de regalarla. Monetízala de forma segura.',
      items: {
        micropayments: {
    ...
    cta: {
      ...
      body: 'Únete a los vendedores que ya están ganando USDC de forma pasiva. Tus datos son tu tesoro: es hora de desbloquearlos.',
    },
    footer: {
  ...
  marketplace: {
    ...
    filters: {
      minPrice: 'Precio mín.',
      maxPrice: 'Precio máx.',
      minQueries: 'Consultas mín.',
      reset: 'Restablecer filtros',
      selectedTypes: '{count} seleccionados',
    },
    pagination: {
      previous: 'Anterior',
      next: 'Siguiente',
  ...
  sell: {
    ...
    form: {
      ...
      datasetNamePlaceholder: 'p. ej. Top 100 movimientos de whale wallets — abril de 2026',
      ...
      sellerWalletHelp: 'El 95 % de cada pago por consulta se envía aquí automáticamente',
  ...
  queryModal: {
    ...
    details: {
      ...
      questionPlaceholder: 'p. ej. ¿Qué wallet movió más ETH? ¿Cuál es la wallet de mayor riesgo?',
      escrowNote: 'El escrow con IA verifica tu pago en Stellar antes de liberar los datos',
    },
    payment: {
      ...
      demoModeDescription: 'omitir el pago y obtener solo el análisis IA (modo hackathon)',
    },
    verifying: {
