...
export const fr: EnglishMessages = {
  ...
  landing: {
    ...
    features: {
      ...
      body: 'Hazina — trésor en swahili — représente la valeur inexploité de votre intelligence on-chain. Arrêtez de la donner gratuitement. Monétisez-la en toute sécurité.',
      items: {
        micropayments: {
    ...
    cta: {
      ...
      body: 'Rejoignez les vendeurs qui gagnent déjà des USDC passivement. Vos données sont votre trésor — il est temps de les débloquer.',
    },
    footer: {
  ...
  marketplace: {
    ...
    filters: {
      minPrice: 'Prix min.',
      maxPrice: 'Prix max.',
      minQueries: 'Requêtes min.',
      reset: 'Réinitialiser',
      selectedTypes: '{count} sélectionnés',
    },
    pagination: {
      previous: 'Précédent',
      next: 'Suivant',
  ...
  sell: {
    ...
    form: {
      ...
      datasetNamePlaceholder: 'ex. Top 100 des mouvements de whale wallets — avril 2026',
  ...
  queryModal: {
    ...
    details: {
      ...
      escrowNote: "L'escrow IA vérifie votre paiement sur Stellar avant de libérer les données",
    },
    payment: {
      ...
      demoModeDescription: "ignorer le paiement et obtenir seulement l'analyse IA (mode hackathon)",
    },
    verifying: {
