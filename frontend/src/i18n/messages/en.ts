...
export const en = {
  ...
  landing: {
    ...
    features: {
      ...
      body: 'Hazina — treasure in Swahili — represents the untapped value in your on-chain intelligence. Stop giving it away free. Monetize it securely.',
      items: {
        micropayments: {
    ...
    cta: {
      ...
      body: "Join the sellers already earning USDC passively. Your data is your treasure — it's time to unlock it.",
    },
    footer: {
  ...
  marketplace: {
    ...
    subtitle: 'Premium on-chain intelligence, priced per query. Pay only for what you need.',
    searchPlaceholder: 'Search datasets...',
    filterBy: 'Filter by {type}',
    filters: {
      minPrice: 'Min price',
      maxPrice: 'Max price',
      minQueries: 'Min queries',
      reset: 'Reset filters',
      selectedTypes: '{count} selected',
    },
    pagination: {
      previous: 'Previous',
      next: 'Next',
  ...
  sell: {
    ...
    earnings: {
      ...
      footnote: 'After 5% platform fee. Paid in USDC directly to your Stellar wallet.',
    },
    tips: {
  ...
  queryModal: {
    ...
    details: {
      ...
      questionPlaceholder: "e.g. Which wallet moved the most ETH? What's the highest risk wallet?",
      escrowNote: 'AI escrow verifies your payment on Stellar before releasing data',
    },
    payment: {
      ...
      demoModeDescription: 'skip payment, just get AI analysis (hackathon mode)',
    },
    verifying: {
